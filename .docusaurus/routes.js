...
export default [
  {
    path: '/km/about-us/',
    component: ComponentCreator('/km/about-us/', '3c9'),
    exact: true
  },
  {
    path: '/km/blog',
  ...
  {
    path: '/km/docs',
    component: ComponentCreator('/km/docs', '0c4'),
    routes: [
      {
        path: '/km/docs',
        component: ComponentCreator('/km/docs', 'aca'),
        routes: [
          {
            path: '/km/docs',
            component: ComponentCreator('/km/docs', 'dac'),
            routes: [
              {
              ...
              {
                path: '/km/docs/crs2mdl2lsn2',
                component: ComponentCreator('/km/docs/crs2mdl2lsn2', '9fd'),
                exact: true,
                sidebar: "course2"
              },
              {
                path: '/km/docs/crs2mdl2lsn3',
                component: ComponentCreator('/km/docs/crs2mdl2lsn3', '3ae'),
                exact: true,
                sidebar: "course2"
              },
              {
                path: '/km/docs/crs2mdl3lsn1',
                component: ComponentCreator('/km/docs/crs2mdl3lsn1', 'a20'),
                exact: true,
                sidebar: "course2"
              },
              {
                path: '/km/docs/crs2mdl3lsn2',
                component: ComponentCreator('/km/docs/crs2mdl3lsn2', 'd9e'),
                exact: true,
                sidebar: "course2"
              },
              {
                path: '/km/docs/crs2mdl3lsn3',
                component: ComponentCreator('/km/docs/crs2mdl3lsn3', 'a06'),
                exact: true,
                sidebar: "course2"
              },
              {
                path: '/km/docs/crs2mdl3lsn4',
                component: ComponentCreator('/km/docs/crs2mdl3lsn4', '1ed'),
                exact: true,
                sidebar: "course2"
              },
              {
